...
class StubInMemorySearchableReposytory extends InMemorySearchableRepository<StubEntity>{
...
describe('InMemorySearchableRepository Unit Tests', () => {
    let repository: StubInMemorySearchableReposytory

    beforeEach(() => repository = new StubInMemorySearchableReposytory())
    describe('applyFilter method', () => {

        it('should no filter items when filter param is null ', async () => {
            const items = [new StubEntity({ name: 'name test', price: 10 })]
    ...
    describe('applySort method', () => {
        it('should no short items', async () => {
            const items = [
    ...
    describe('search method', () => {
        ...
        it('should apply only paginate whe other params are null', async () => {

            const entity = new StubEntity({ name: 'hello', price: 45 })
        ...
        it('should apply paginate an filter', async () => {
            const items = [
